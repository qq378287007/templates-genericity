...
{ 
	...
	*/
	...
	//-------------------------------
	//泛化版本
	template <class TPLT, unsigned int index_v, typename
		DefaultType = NullTypelist>
	class find_nostrict
	{
	public:
...
{	
	...
	using TmpType = tplt::push_front< tplt::pop_front<TPL_NM1>::type, __int64>::type;
	...
	*/
	...
	//cout << typeid(tplt::get_maxsize_type< TPL_NM1>::type).name() << endl;
	...
	*/
	...
	_nmsp1::TestTPClass<MAC_TYPELIST2(int, int)> myodtpobj;
